      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Click the button below to contact me directly via WhatsApp. I am
            ready to help you for consultations, collaborations, or just to say
            hello!
          </p>
        </div>
        <div className="flex flex-col items-center">
          ...
          >
            ...
            WhatsApp Chat: +62 888 0911 2177
          </a>
